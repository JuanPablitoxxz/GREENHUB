      ...
      <section className="min-h-screen pt-36 md:pt-40 pb-16 px-4 flex flex-col items-center justify-center text-center hero-gradient max-w-7xl mx-auto">
        ...
        >
          ...
          <h1 className="text-5xl sm:text-7xl md:text-8xl font-display font-extrabold tracking-tight text-white leading-[1.05] glow-text-emerald">
            Reinventing Urban <span className="text-emerald-400">Waste</span>, Together.
          </h1>

          <p className="text-base sm:text-lg md:text-xl text-slate-400 max-w-2xl mx-auto font-light leading-relaxed">
            Join the next-generation environmental ecosystem. We transform sustainable daily actions into premium rewards through holographic tracking and bioluminescent tech.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="group relative p-8 md:p-10 glass-panel rounded-2xl hover:-translate-y-2.5 transition-all duration-500 border border-white/5 flex flex-col justify-between">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-display font-bold text-white mb-3">Collection</h3>
              <p className="text-slate-400 font-light leading-relaxed text-sm">
                Smart receptacles track your deposit in real-time using IoT sensors and machine vision.
              </p>
            </div>
            <div className="mt-8 overflow-hidden rounded-xl aspect-video glass-panel border border-white/5 relative">
              <img 
                alt="Futuristic waste bin" 
          ...
          <div className="group relative p-8 md:p-10 glass-panel rounded-2xl hover:-translate-y-2.5 transition-all duration-500 border border-white/5 flex flex-col justify-between">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-display font-bold text-white mb-3">Separation</h3>
              <p className="text-slate-400 font-light leading-relaxed text-sm">
                Automated holographic sorting ensures 100% material recovery with microscopic precision.
              </p>
            </div>
            <div className="mt-8 overflow-hidden rounded-xl aspect-video glass-panel border border-white/5 relative">
              <img 
                alt="Holographic sorting" 
                className="w-full h-full object-cover opacity-50 group-hover:scale-110 group-hover:opacity-80 transition-all duration-700" 
          ...
          <div className="group relative p-8 md:p-10 glass-panel rounded-2xl hover:-translate-y-2.5 transition-all duration-500 border border-white/5 flex flex-col justify-between">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-display font-bold text-white mb-3">Reward</h3>
              <p className="text-slate-400 font-light leading-relaxed text-sm">
                Convert your impact into Eco-Credits for premium services, transport, and community perks.
              </p>
            </div>
            <div className="mt-8 overflow-hidden rounded-xl aspect-video glass-panel border border-white/5 relative">
              <img 
